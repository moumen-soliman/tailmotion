...
const SIMPLE_KEYFRAMES = {
  ...
  'tm-glow': {
    '0%, 100%': { 'box-shadow': '0 0 0 0 var(--tm-glow-color)' },
    '50%': { 'box-shadow': '0 0 var(--tm-glow-size, 18px) var(--tm-glow-spread, 0) var(--tm-glow-color)' },
  },
  'tm-morph': {
    '0%, 100%': { transform: 'scale(1) rotate(0deg)', 'border-radius': 'inherit' },
  ...
  'tm-ripple': {
    '0%': { transform: 'scale(1)', 'box-shadow': '0 0 0 0 var(--tm-outline-color)' },
    '40%': { transform: 'scale(1.03)', 'box-shadow': '0 0 0 var(--tm-ripple-size, 10px) transparent' },
