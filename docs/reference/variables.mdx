...
| `--tm-stagger-blur` | `0px` | `tm-stagger`. `tm-stagger-blur` sets it to `8px` |
...
| `--tm-shimmer-text-angle` | `100deg` | `tm-shimmer-text` |
| `--tm-shimmer-text-band` | `400%` | `tm-shimmer-text` |
| `--tm-number-stagger-step` | `40ms` | `tm-number-swap` |
| `--tm-stream-text-stagger-step` | `60ms` | `tm-stream-text` |
| `--tm-stream-text-blur` | `6px` | `tm-stream-text` |
| `--tm-ring-width` | — | `tm-avatar-ring` |
| `--tm-avatar-more-bg` | `--tm-outline-color` | `tm-avatar-more` |
...
| `--tm-shimmer-text-color` | `--tm-color` |
| `--tm-shimmer-text-resting` | 45% of `--tm-shimmer-text-color` |
