...
| Entry | Raw | Gzipped |
|---|---|---|
| `tailmotion/css` | 215 KB | 31.6 KB |
| `tailmotion/recipes.css` | 22.3 KB | 6.4 KB |
| `tailmotion/native.css` | 17.4 KB | 5.0 KB |
| `tailmotion/choreography.css` | 16.1 KB | 4.8 KB |
| `tailmotion/presence.css` | 15.0 KB | 4.7 KB |
| `tailmotion/scroll.css` | 12.6 KB | 4.1 KB |
| `tailmotion/profiles.css` | 11.8 KB | 3.7 KB |
...
class whether you use them or not, and 31.6 KB gzipped is the whole file. CSS
...
<AccordionGroup>
  <Accordion title="I want the whole library">
    ...
    ```
    31.6 KB gzipped, no build step, no plugin, every class available. This is
  ...
  <Accordion title="I only need presence">
    ...
    ```
    4.7 KB gzipped, works standalone. Add `tailmotion/profiles.css` if you also
